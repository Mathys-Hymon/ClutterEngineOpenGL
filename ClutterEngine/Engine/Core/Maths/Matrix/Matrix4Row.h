...
/**
 * @brief 4x4 matrix (row-major) for 3D transformations.
 */
struct CLUTTER_API Matrix4Row
{
    /**
     * @brief The matrix elements in row-major order.
     */
    float mat[4][4];
    ...
    /**
     * @brief Multiplies a matrix by a Vector3 (assumes w=1).
     * @param mat Matrix.
     * @param vec Vector3.
    ...
    /**
     * @brief Multiplies a matrix by a Vector4.
     * @param mat Matrix.
     * @param vec Vector4.
    ...
    /**
     * @brief Gets the normalized X axis (right vector) of the matrix.
     * @return X axis as Vector3.
     */
    Vector3 GetXAxis() const
    {
        return Vector3::Normalize(Vector3(mat[0][0], mat[0][1], mat[0][2]));
    ...
    /**
     * @brief Gets the normalized Y axis (up vector) of the matrix.
     * @return Y axis as Vector3.
     */
    Vector3 GetYAxis() const
    {
        return Vector3::Normalize(Vector3(mat[1][0], mat[1][1], mat[1][2]));
    ...
    /**
     * @brief Gets the normalized Z axis (forward vector) of the matrix.
     * @return Z axis as Vector3.
     */
    Vector3 GetZAxis() const
    {
        return Vector3::Normalize(Vector3(mat[2][0], mat[2][1], mat[2][2]));
    ...
    /**
     * @brief Gets the scale component of the matrix.
    ...
    /**
     * @brief Inverts a matrix (static version).
    ...
    /**
     * @brief Creates a scale matrix from a Vector3.
    ...
    /**
     * @brief The identity matrix constant.
     */
    static const Matrix4Row Identity;
};
