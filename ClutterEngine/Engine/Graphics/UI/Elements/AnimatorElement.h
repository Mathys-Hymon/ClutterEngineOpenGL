...
namespace clt
{
	...
	public:
		AnimatorElement(std::string pAnimName, const std::vector<std::weak_ptr<Texture>>& pTextures, bool pLooping = true, float pAnimFps = 24, Vector2 pSize = { 1.0f, 1.0f }, Vector2 pPosition = { 0.0f, 0.0f }, int zOrder = 0);
		...
		void AddNewAnim(std::string pAnimName, const std::vector< std::weak_ptr<Texture>>& pTextures, bool pLooping = true, float pAnimFps = 24, int pDrawOrder = 100);
